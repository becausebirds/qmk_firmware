...
|------+------+------+------+------+------+------+------+------+------+------+------|
| Ctrl | LGUI | Alt  |TO_Num| Lower|    Space    |Raise | Left | Down |  Up  |Right |
`-----------------------------------------------------------------------------------'
...
[_LOWER] = LAYOUT_planck_1x2uC(
    ...
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  LCTL(KC_C),  LCTL(KC_V),  KC_NO,      _______,      _______,   _______,   _______,
    _______, _______, _______, _______, _______, KC_SPC, TO(NUMBERS), _______,    KC_MUTE,    KC_VOLD,    KC_VOLU
),
...
[_RAISE] = LAYOUT_planck_1x2uC(
    ...
    _______, _______, _______, _______, TO(NUMBERS), KC_SPC, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU
),
